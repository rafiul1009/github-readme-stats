...
import type { CommitLanguageStat } from "@/lib/commitLanguages";

export interface MostCommitLanguageCardOverrides {
  background?: string;
  border?: string;
  title?: string;
  text?: string;
...
export interface MostCommitLanguageCardProps {
  languages: CommitLanguageStat[];
  customTitle?: string;
  theme: ThemeDefinition;
  overrides?: MostCommitLanguageCardOverrides;
  locale?: string;
...
export function MostCommitLanguageCard({
  languages,
  customTitle,
  theme,
  overrides = {},
  ...
  const title = customTitle || t(locale, "mostCommitLanguageTitle");
